...
export default function TechStack() {
  return (
    <StaticAuroraBackground>
      <div id="tech-stack" className="flex flex-col gap-8 w-[92%] xl:w-6xl mx-auto bg-white/20 backdrop-blur-lg rounded-3xl py-32 border px-4 xl:px-0 border-white/30">
        <div className="flex flex-col gap-2">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h1 className="flex uppercase text-lg sm:text-xl tracking-[0.5em] min-[330px]:tracking-[0.8em] font-bold text-white drop-shadow-lg">Tech Stack</h1>
          </motion.div>
